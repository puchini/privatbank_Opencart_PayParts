...
$_['heading_title']    = 'Оплата частями - Деньги в периоде (ПриватБанк)';


// Text
$_['text_module']      = 'Оплата';
//$_['text_success']     = 'Success: You have modified PrivatbankPaymentparts account details!';
$_['text_success']     = "Выполнено: Вы изменили параметры 'Оплата частями - Деньги в периоде (ПриватБанк)!'";
//$_['text_edit']        = 'Редактирование Оплаты частями и Мгновенной рассрочки';
$_['text_edit']        = 'Редактирование Приватбанк Оплата частями(Деньги в периоде)';
$_['text_privatbank_paymentparts_pb'] = '<a target="_BLANK" href="https://payparts2.privatbank.ua/ipp/"><img src="view/image/payment/pbPayPat.png" alt="Privatbank Paymentparts" title="Privatbank Paymentparts" style="border: 1px solid #EEEEEE;width: 56px;height: 35px" /></a>';
...
//merchantType
$_['entry_merchantType_pb'] = 'Оплата частями(Деньги в периоде):';
//shop identification
...
$_['error_privatbank_paymentparts_pb_shop_id'] = 'Необходим ID магазина!';
$_['error_privatbank_paymentparts_pb_shop_password'] = 'Необходим пароль магазина!';
...
//Help
$_['help_merchantType_pb']       = "Выберите количество платежей по сервису 'Оплата частями'";
?>