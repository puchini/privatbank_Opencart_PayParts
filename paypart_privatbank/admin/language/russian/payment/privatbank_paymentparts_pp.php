...
$_['text_success']     = "Выполнено: Вы изменили параметры 'Оплата частями (ПриватБанк)!'";
//$_['text_edit']        = 'Редактирование Оплаты частями и Мгновенной рассрочки';
$_['text_edit']        = 'Редактирование Приватбанк Оплата частями';
...
//merchantType
$_['entry_merchantType_pp'] = 'Оплата частями:';
//shop identification
...
$_['error_privatbank_paymentparts_pp_shop_id'] = 'Необходим ID магазина!';
$_['error_privatbank_paymentparts_pp_shop_password'] = 'Необходим пароль магазина!';
...
//Help
$_['help_merchantType_pp']       = "Выберите количество платежей по сервису 'Оплата частями'";
