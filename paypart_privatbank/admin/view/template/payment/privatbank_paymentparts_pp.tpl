...
<!--                <label class="col-sm-2 control-label" for="input-shop-id"><span data-toggle="tooltip" title="<?php echo $help_shop_id; ?>"><?php echo $entry_shop_id; ?></span></label>-->
                ...
                <div class="col-sm-10">
                  ...
                  <?php if ($error_privatbank_paymentparts_pp_shop_id) { ?>
                  <div class="text-danger"><?php echo $error_privatbank_paymentparts_pp_shop_id; ?></div>
                  <?php } ?>                  
                </div>
              </div>
              <!--  shop: password  -->
...
<!--                <label class="col-sm-2 control-label" for="input-shop-password"><span data-toggle="tooltip" title="<?php echo $help_shop_password; ?>"><?php echo $entry_shop_password; ?></span></label>-->
                ...
                <div class="col-sm-10">
                  ...
                  <?php if ($error_privatbank_paymentparts_pp_shop_password) { ?>
                  <div class="text-danger"><?php echo $error_privatbank_paymentparts_pp_shop_password; ?></div>
                  <?php } ?>                   
                </div>                
              </div>
              ...
              <!--  merchantType   -->
              <div class="form-group">                  
                <label class="col-sm-2 control-label" for="input-merchantType-pp"><span data-toggle="tooltip" title="<?php echo $help_merchantType_pp; ?>"><?php echo $entry_merchantType_pp; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="privatbank_paymentparts_pp_merchantType" value="<?php echo $privatbank_paymentparts_pp_merchantType; ?>" placeholder="<?php echo $entry_merchantType_pp; ?>" id="input-merchantType-pp" class="form-control"/>
                </div>
              </div>
              <!-- End merchantType   -->
