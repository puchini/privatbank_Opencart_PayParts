...
<!--                <label class="col-sm-2 control-label" for="input-shop-id"><span data-toggle="tooltip" title="<?php echo $help_shop_id; ?>"><?php echo $entry_shop_id; ?></span></label>-->
                ...
                <div class="col-sm-10">
                  ...
                  <input type="text" name="privatbank_paymentparts_pb_shop_id" value="<?php echo $privatbank_paymentparts_pb_shop_id; ?>" placeholder="<?php echo $entry_shop_id; ?>" id="input-shop-id" class="form-control"/>
                  <?php if ($error_privatbank_paymentparts_pb_shop_id) { ?>
                  <div class="text-danger"><?php echo $error_privatbank_paymentparts_pb_shop_id; ?></div>
                  <?php } ?>                   
                </div>
              </div>
              <!--  shop: password  -->
...
<!--                <label class="col-sm-2 control-label" for="input-shop-password"><span data-toggle="tooltip" title="<?php echo $help_shop_password; ?>"><?php echo $entry_shop_password; ?></span></label>-->
                ...
                <div class="col-sm-10">
                  <input type="text" name="privatbank_paymentparts_pb_shop_password" value="<?php echo $privatbank_paymentparts_pb_shop_password; ?>" placeholder="<?php echo $entry_shop_password; ?>" id="input-shop-password" class="form-control"/>
                  <?php if ($error_privatbank_paymentparts_pb_shop_password) { ?>
                  <div class="text-danger"><?php echo $error_privatbank_paymentparts_pb_shop_password; ?></div>
                  <?php } ?>                   
                </div>                
              </div>
              ...
              <!--  merchantType: pb  -->
              <div class="form-group">                  
                <label class="col-sm-2 control-label" for="input-merchantType-pb"><span data-toggle="tooltip" title="<?php echo $help_merchantType_pb; ?>"><?php echo $entry_merchantType_pb; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="privatbank_paymentparts_pb_merchantType" value="<?php echo $privatbank_paymentparts_pb_merchantType; ?>" placeholder="<?php echo $entry_merchantType_pb; ?>" id="input-merchantType-pb" class="form-control"/>
                </div>                
              </div> 
              <!-- End merchantType   -->
...
<!--              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="privatbank_paymentparts_pb_status" id="input-status" class="form-control">
                    <?php if ($privatbank_paymentparts_pb_status) { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                    <?php } else { ?>
                    <option value="1"><?php echo $text_enabled; ?></option>
              ...
              <div class="tab-pane" id="tab-status">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select name="privatbank_paymentparts_pb_completed_status_id" class="form-control">
                        <?php foreach ($order_statuses as $order_status) { ?>
                        <?php if ($order_status['order_status_id'] == $privatbank_paymentparts_pb_completed_status_id) { ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select name="privatbank_paymentparts_pb_canceled_status_id" class="form-control">
                        <?php foreach ($order_statuses as $order_status) { ?>
                        <?php if ($order_status['order_status_id'] == $privatbank_paymentparts_pb_canceled_status_id) { ?>
                        <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                        <?php } else { ?>
                        <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                        <?php } ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select name="privatbank_paymentparts_pb_clientwait_status_id" class="form-control">
                        <?php foreach ($order_statuses as $order_status) { ?>
                        <?php if ($order_status['order_status_id'] == $privatbank_paymentparts_pb_clientwait_status_id) { ?>
                        <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                        <?php } else { ?>
                        <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                        <?php } ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select name="privatbank_paymentparts_pb_created_status_id" class="form-control">
                        <?php foreach ($order_statuses as $order_status) { ?>
                        <?php if ($order_status['order_status_id'] == $privatbank_paymentparts_pb_created_status_id) { ?>
                        <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                        <?php } else { ?>
                        <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                        <?php } ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select name="privatbank_paymentparts_pb_failed_status_id" class="form-control">
                        <?php foreach ($order_statuses as $order_status) { ?>
                        <?php if ($order_status['order_status_id'] == $privatbank_paymentparts_pb_failed_status_id) { ?>
                        <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                        <?php } else { ?>
                        <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                        <?php } ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select name="privatbank_paymentparts_pb_rejected_status_id" class="form-control">
                        <?php foreach ($order_statuses as $order_status) { ?>
                        <?php if ($order_status['order_status_id'] == $privatbank_paymentparts_pb_rejected_status_id) { ?>
                        <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                        <?php } else { ?>
                        <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                        <?php } ?>
